...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Image_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Image_t qt_meta_stringdata_Image = {
    {
QT_MOC_LITERAL(0, 5), // "Image"
...
void Image::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Image::*)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Image::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Image::staticMetaObject = { {
    ...
    qt_meta_stringdata_Image.offsetsAndSize,
    qt_meta_data_Image,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Image_t
, QtPrivate::TypeAndForceComplete<Image, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QPixmap, std::false_type>
...
// SIGNAL 0
void Image::clicked(QPixmap _t1)
{
